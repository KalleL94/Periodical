...
echo "  Admin: admin (password printed by migrate_to_db.py, MUST CHANGE ON FIRST LOGIN)"
echo "  Users: user01-user10 (password printed by migrate_to_db.py, must be changed on first login)"
echo ""
