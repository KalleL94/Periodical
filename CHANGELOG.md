...
### Fixed
- Övertid inlagd på en semestervecka ersatte semesterdagen (SEM) i schemavyerna och räknades dessutom som övertidslön. Semester har nu företräde framför övertid, precis som frånvaro och föräldraledighet redan hade. Dagen visas åter som semester och ingen övertidslön läggs på. Dagsemester som lagts in som frånvaro var inte drabbad
